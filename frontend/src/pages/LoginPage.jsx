...
export default function LoginPage() {
    ...
    return (
        <div className="min-height-screen flex items-center justify-center px-4 py-20 relative overflow-hidden">
            ...
            >
                <div className="glass-card p-8 relative overflow-hidden">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-3xl font-bold text-nexus-text mb-2">Welcome Back</h1>
                        <p className="text-nexus-muted">Sign in to continue optimizing your resume</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center ml-1">
                                <label className="text-sm font-medium text-nexus-muted" htmlFor="password">Password</label>
